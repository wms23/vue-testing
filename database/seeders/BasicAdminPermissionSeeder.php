...
class BasicAdminPermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $role1->givePermissionTo('account-type list');
        $role1->givePermissionTo('account-type create');
        $role1->givePermissionTo('account-type edit');
        $role1->givePermissionTo('account-type delete');
