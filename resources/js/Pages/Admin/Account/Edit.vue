...
const form = useForm({
    ...
    accountType: props.account.account_type_id,
});
const submit = () => {
                        ...
                        <form name="createForm" @submit.prevent="submit">
                            ...
                            <div className="flex flex-col">
                                <div className="relative mb-4">
                                    <select data-te-select-init data-te-select-filter="true" data-te-select-size="lg" v-model="form.accountType"
                                        name="accountType" id="accountType" class="form-control">
                                        <option value=""></option>
